...
|------|---------------|---------------------|
| 운명의 룰렛 | schemaVersion · topic · spinDurationMs | schemaVersion · seed · winnerMemberIds[] · wheelOrder[](조각 배치, 입장 순서) |
...
| 익명 저격 | schemaVersion · topic · voteSec · allowMultiVote · revealVoters | schemaVersion · tally[{memberId, hitCount}] · winnerMemberIds[] · ballotRounds · abstainCount · decidedByRandom · voters[{voterMemberId, targetMemberId}](revealVoters일 때만) |
