...
> **대상**: 요구사항 194항의 도메인별 추적 관계 · 구 스펙 ID 대응표 · 커버리지 판정
> **작성일**: 2026-08-02
> **원천**: [README.md](./README.md)(REQ 194 · AC 120 채번 정본) · [../02_features/README.md](../02_features/README.md)(기능 121 채번 정본) · [../08_screen/README.md](../08_screen/README.md)(화면 12본) · [../06_database/README.md](../06_database/README.md)(테이블 6) · docs_legacy/requirements.md(구 US·G·NFR)
...
| 익명 저격 | REQ-SNIPE **10** | F-SNIPE 8 | SNIPE-PLAY | game_rounds · game_options · votes · game_results |
...
21 + 17 + 16 + 15 + 7 + 9 + 14 + 14 + 10 + 10 + 10 + 11 = **154**(도메인) · 24 + 16 = **40**(횡단) · 합 **194**이다.
...
| US-41x~46x 게임별 | 12 | REQ-WHEEL·LADDER·KING·TIMER·SNIPE·NUNCHI | 게임별 접두사로 분화, 합 64건 |
...
**구 40항이 신 194항으로 늘어난 이유**는 범위가 커져서가 아니라 **검증 단위로 쪼갰기 때문**이다. 구 스펙의 사용자 스토리 하나가 Given/When/Then 여러 줄을 품고 있었고, 그 줄 하나하나가 독립적으로 검증 가능한 요구사항이므로 각각을 REQ로 채번했다. 검증할 수 없는 크기의 요구사항은 요구사항이 아니다.
